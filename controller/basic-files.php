...
fwrite($file1, '<IfModule mod_rewrite.c>
  RewriteEngine on 
...
fwrite($file3, '<?php require_once("../controller/script.php");
...
fwrite($file4, '<?php if (!isset($_SESSION)) {
  session_start();
}
...
fwrite($file8, '<?php if (!isset($_SESSION[""])) {
  session_start();
}
...
fwrite($file10, '<meta charset="utf-8">
...
fwrite($file11, '<footer class="footer">
...
fwrite($file12, '<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
<title><?= $_SESSION["page-name"] ?> - ' . $name . '</title>
<link rel="stylesheet" href="../assets/css/feather.css">
<link rel="stylesheet" href="../assets/mdi/css/materialdesignicons.min.css">
...
fwrite($file13, '<nav class="sidebar sidebar-offcanvas shadow" style="background-color: rgb(3, 164, 237);" id="sidebar">
  <ul class="nav">
    <li class="nav-item">
    ...
    <li class="nav-item">
      <a class="nav-link" style="cursor: pointer;" onclick="window.location.href=' . $petik . 'icons' . $petik . '">
...
fwrite($file14, '<nav class="navbar default-layout col-lg-12 col-12 p-0 fixed-top d-flex align-items-top flex-row">
...
fwrite($file16, '<?php require_once("../controller/script.php");
...
fwrite($file17, '<?php require_once("../controller/script.php");
require_once("redirect.php");
...
fwrite($file18, '<?php if (!isset($_SESSION["data-user"])) {
...
fwrite($file19, '<?php require_once("../controller/script.php");
require_once("redirect.php");
...
fwrite($file20, '<?php require_once("../controller/script.php");
require_once("redirect.php");
...
fwrite($file21, '<?php require_once("../controller/script.php"); ?>
